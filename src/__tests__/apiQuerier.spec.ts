...
import makeApiQuerier, { processRemoteResources } from '../index';
...
describe('repository', () => {
  ...
  describe('makeApiQuerier', () => {
    ...
    it('Calls the resourceProcessor function for each\
      ...
      makeApiQuerier(resourceNames, baseURL, commonHeaders, processRemoteResourcesMock);
